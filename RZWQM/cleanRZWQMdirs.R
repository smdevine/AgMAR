...
cleanRZWQMdirs(stn = station, scn = 'SteadyStateRuns', soilnames = compnames)
cleanRZWQMdirs(stn = station, scn = 'AgMAR_Jan3d', soilnames = compnames)
cleanRZWQMdirs(stn = station, scn = 'AgMAR_Jan7d', soilnames = compnames)
cleanRZWQMdirs(stn = station, scn = 'AgMAR_Mar3d', soilnames = compnames)
cleanRZWQMdirs(stn = station, scn = 'AgMAR_Mar7d', soilnames = compnames)
cleanRZWQMdirs(stn = station, scn = 'AgMAR_21d', soilnames = compnames)
