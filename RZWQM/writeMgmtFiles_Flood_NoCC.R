...
cover_crop <- FALSE
rye_date_planting <- '14   1   1992' #day followed by month followed by dummy year
rye_date_harvest <- '28 1 1993'
rye_emergence <- '10' #2 days before harvest
...
rye_line1 <- paste('3', rye_date_planting, '10.0   2 0.0   0 -99.0', rye_emergence, '-99.0   -99', sep = '  ') #this was ...2 76000.0... for actual cover crop
rye_line2 <- paste('               3 0.0   0 0.0', rye_date_harvest, sep = ' ')
rye_line3 <- '               10.0  0.9   4 10 15'
...
writeIrrPlan <- function(start_year=1984, end_year=2020, irrigationAssumptions='0  0  0.0  100.0  15.0  0.0  0', cornADtrigger1='0.6', cornDaystrigger1='3', cornDaystrigger2='60', cornADtrigger2='0.5', tomADtrigger1='0.8', tomDaystrigger1='3', tomADtrigger2='0.6', tomDaystrigger2='84', tomADtrigger3='0.4', tomDaystrigger3='135', tomFilltrigger3='0.75', IrrAppPlanting=1.25, flood_month='1', flood_days=c('15', '19', '23', '27'), flood_app=15.0, wet_yrs) {
  ...
  IrrPlan <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
      corn_line1 <- paste('1  2  3  3 20 4', x, '1 9', x, '2 0.0  0.0', sep=' ') #date is 4/14; that #2 near the beginning should be a 3 for 'furrow'
      ...
      tom_line1 <- paste('2  2  3  3 20 4', x, '15 9', x, '2 0.0  0.0', sep=' ') #date is 4/14
...
Irr_plan <- writeIrrPlan(flood_month = '1', wet_yrs = wet_years)
Irr_plan
