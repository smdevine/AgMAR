#to-do
#1: make crop planting not dependent on soil moisture
...
writePlantingPlan <- function(corn_line1 = '1  15   4  1984  20.0   3 40000.0   0 -99.0   10 -99.0   -99',  corn_line2 = '               1 1.0   0 0.0  0 0 0', corn_line3 = '               10.0  0.95   3 0 0', tomato_line1 = '2  15   4  1985  150.0   2 40000.0   0 -99.0   10 -99.0   -99', tomato_line2 = '               1 1.0   0 0.0  0 0 0', tomato_line3 = '               10.0  0.55   4 0 0', start_year = 1984, end_year = 2020) {
...
writePlantingPlan_AgMAR <- function(start_year=1984, end_year=2020, wet_years, cover_crop = FALSE, rye_date_planting = '14   1   1992', rye_date_harvest = '28 1 1993', rye_emergence = '10', corn_line1 = '1  15   4  1984  20.0   3 40000.0   0 -99.0   10 -99.0   -99', corn_line2 = '               1 1.0   0 0.0  0 0 0', corn_line3 = '               10.0  0.95   3 0 0', tomato_line1 = '2  15   4  1985  150.0   2 40000.0   0 -99.0   10 -99.0   -99', tomato_line2 = '               1 1.0   0 0.0  0 0 0', tomato_line3 = '               10.0  0.55   4 0 0', rye_line1 = paste('3', rye_date_planting, '10.0   2 0.0   0 -99.0', rye_emergence, '-99.0   -99', sep = '  '), rye_line2 = paste('               3 0.0   0 0.0', rye_date_harvest, sep = ' '), rye_line3 = '               10.0  0.9   4 0 0') {
  years <- start_year:end_year
  ...
  planting_plan <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
      ...
      if((x)%in%wet_years) {
        ...
        rye_line2_final <- rye_line2
        substring(rye_line2_final, 35, 38) <- if(cover_crop){as.character((x+1))}else{as.character(x)}
        c(rye_line1_final, rye_line2_final, rye_line3, tomato_line1_final, tomato_line2, tomato_line3)
      } else {c(tomato_line1_final, tomato_line2, tomato_line3)}
    }
  }))
  planting_data <- c(as.character(plantings), planting_plan)
  planting_data
...
writePlantingPlan_AgMAR_LF <- function (start_year=1984, end_year=2020, wet_years, cover_crop = FALSE, rye_date_planting, rye_date_harvest, rye_emergence = '10', corn_line1 = '1  15   4  1984  20.0   3 40000.0   0 -99.0   10 -99.0   -99', corn_line2 = '               1 1.0   0 0.0  0 0 0', corn_line3 = '               10.0  0.95   3 0 0', tomato_line1 = '2  15   4  1985  150.0   2 40000.0   0 -99.0   10 -99.0   -99', tomato_line2 = '               1 1.0   0 0.0  0 0 0', tomato_line3 = '               10.0  0.55   4 0 0') {
  ...
  planting_plan <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
      ...
      if((x)%in%wet_years) {
        rye_lines <- as.character(mapply(FUN=rye_planting, y = rye_date_planting, z = rye_date_harvest, k=x, SIMPLIFY = TRUE))
        c(rye_lines, tomato_line1_final, tomato_line2, tomato_line3)
      } else {c(tomato_line1_final, tomato_line2, tomato_line3)}
    }
  }))
  planting_data <- c(as.character(plantings), planting_plan)
...
writeIrrPlan <- function(start_year=1984, end_year=2020, irrigationAssumptions='0  0  0.0  100.0  15.0  0.0  0', cornADtrigger1='0.6', cornDaystrigger1='3', cornDaystrigger2='60', cornADtrigger2='0.5', tomADtrigger1='0.8', tomDaystrigger1='3', tomADtrigger2='0.6', tomDaystrigger2='84', tomADtrigger3='0.4', tomDaystrigger3='135', tomFilltrigger3='0.75', IrrAppPlanting=1.25) {
  ...
  IrrPlan <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
      ...
      tom_line1 <- paste('2  2  3  3 20 4', x, '15 9', x, '0 0.0  0.0', sep=' ') #date is 4/14
...
writeIrrPlan_AgMAR <- function(start_year=1984, end_year=2020, irrigationAssumptions='0  0  0.0  100.0  15.0  0.0  0', cornADtrigger1='0.6', cornDaystrigger1='3', cornDaystrigger2='60', cornADtrigger2='0.5', tomADtrigger1='0.8', tomDaystrigger1='3', tomADtrigger2='0.6', tomDaystrigger2='84', tomADtrigger3='0.4', tomDaystrigger3='135', tomFilltrigger3='0.75', IrrAppPlanting=1.25, flood_month='1', flood_days=c('15', '19', '23', '27'), flood_app=15.0, wet_yrs) {
  years <- start_year:end_year
  plantings <- length(years)
  IrrPlan <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
  ...
  IrrPlan2 <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
      ...
      tom_line3 <- paste('16  4', x, sep = ' ')
      if(x%in%wet_yrs) {
        c(paste('3  2  2  2', flood_days[1], flood_month, x, flood_days[4], flood_month, x, '0 0.0  2.0', sep=' '), '4', paste(flood_days[1], flood_month, x, sep = '  '), paste(flood_days[2], flood_month, x, sep = '  '), paste(flood_days[3], flood_month, x, sep = '  '), paste(flood_days[4], flood_month, x, sep = '  '), '4', paste(as.character(flood_app), as.character(flood_app), as.character(flood_app), as.character(flood_app)), tom_line1, tom_line2, tom_line3, as.character(IrrAppPlanting))
...
writeIrrPlan_AgMAR_LF <- function(start_year=1984, end_year=2020, irrigationAssumptions='0  0  0.0  100.0  15.0  0.0  0', cornADtrigger1='0.6', cornDaystrigger1='3', cornDaystrigger2='60', cornADtrigger2='0.5', tomADtrigger1='0.8', tomDaystrigger1='3', tomADtrigger2='0.6', tomDaystrigger2='84', tomADtrigger3='0.4', tomDaystrigger3='135', tomFilltrigger3='0.75', IrrAppPlanting=1.25, flood_month, flood_days, flood_app=15.0, wet_yrs) {
  years <- start_year:end_year
  plantings <- length(years)
  IrrPlan <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
  ...
  IrrPlan2 <- do.call(c, lapply(years, function(x) {
    if(x%%2==0) {
      ...
      tom_line3 <- paste('16  4', x, sep = ' ')
      if(x%in%wet_yrs) {
        c(paste('3  2  2  2', flood_days[1], flood_month[1], x, flood_days[1], flood_month[1], x, '0 0.0  2.0', sep=' '), '1', paste(flood_days[1], flood_month[1], x, sep = '  '), '1', as.character(flood_app), paste('3  2  2  2', flood_days[2], flood_month[2], x, flood_days[2], flood_month[2], x, '0 0.0  2.0', sep=' '), '1', paste(flood_days[2], flood_month[2], x, sep = '  '), '1', as.character(flood_app), paste('3  2  2  2', flood_days[3], flood_month[3], x, flood_days[3], flood_month[3], x, '0 0.0  2.0', sep=' '), '1', paste(flood_days[3], flood_month[3], x, sep = '  '), '1', as.character(flood_app), paste('3  2  2  2', flood_days[4], flood_month[4], x, flood_days[4], flood_month[4], x, '0 0.0  2.0', sep=' '), '1', paste(flood_days[4], flood_month[4], x, sep = '  '), '1', as.character(flood_app), tom_line1, tom_line2, tom_line3, as.character(IrrAppPlanting))
      } else {c(tom_line1, tom_line2, tom_line3, as.character(IrrAppPlanting))}
    }
  })
  )
...
#write file
writeRZWQM <- function(station, scenario, soil) {
...
#run SSURGO soils through base runs
compnames <- c('Hanford', 'Delhi', 'Wasco', 'Hesperia', 'Milham', 'Tujunga', 'Panoche', 'Cerini', 'Yolo', 'Colpien', 'Tehama', 'Capay', 'Clear Lake', 'Willows', 'Tulare') #'Channac' not included
fine_soils <- c('Capay', 'Clear Lake', 'Willows', 'Tulare')
stn <- 'Parlier'
for(i in 1:length(compnames)) {
  ...
  fert_plan <- writeFertPlan(end_year = 2020, tomato_N_kg_ha_yr = 200, tomato_splits = 6)
  tillage_plan <- writeTillagePlan(depth = '15.0')
  Irr_plan <- if(compnames[i] %in% fine_soils) {writeIrrPlan(tomADtrigger1='0.95', tomADtrigger2 = '0.9')} else{writeIrrPlan()}
...
fert_plan <- writeFertPlan(end_year = 2020, tomato_N_kg_ha_yr = 200, tomato_splits = 6)
tillage_plan <- writeTillagePlan(depth = '15.0')
Irr_plan <- writeIrrPlan() #tomADtrigger1='0.95', tomADtrigger2 = '0.95'
writeRZWQM(stn, 'BaseRuns', compnames[i])
